        ...
        <div className='container'>
          <div className='flex items-center justify-center md:flex-col'>
            <div className='left w-1/2 text-black md:w-full'>
              ...
              <br/>
              <br/>
              <button type='submit' className='px-3 py-1 focus:outline-none focus:shadow-outline bg-green-500 hover:bg-green-800 hover:text-white '>
                    get Started
                  </button>
            </div>
            <div className='right w-1/2 md:w-full relative'>
              <div className='images relative'>
                <img src={heroImgback} alt='' className=' absolute top-32 left-20 w-96 md:left-10' />
